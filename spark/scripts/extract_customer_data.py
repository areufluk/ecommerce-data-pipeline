...
spark = SparkSession.builder.appName('Extract customer data').getOrCreate()
...
df.write.mode('overwrite').format('parquet').save('gs://ecommerce-data-pipeline/raw/customer')
